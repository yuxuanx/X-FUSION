...
for l = 1:len
    ...
    assignments = gibbs_sampling(wupd(:,2:end),wupd(:,1),w_new(valid_idx),Mt);
    [weight,rMurty,xMurty,pMurty] = mapping(assignments,wupd,rupd,xupd,Pupd,...
        w_new,r_new,x_new,P_new,valid_idx,idx_out,H_threshold);
